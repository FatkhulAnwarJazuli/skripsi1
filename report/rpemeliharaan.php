...
<div class="container-fluid">
    ...
    <div class="table-responsive">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                <?php
                // Query untuk mengambil semua data pemeliharaan dengan JOIN
                $query = "
                    SELECT 
                        pb.id_pemeliharaan, 
                        pb.id_barang, 
                ...
                if ($result && mysqli_num_rows($result) > 0) { //
                    ...
                    while ($data = mysqli_fetch_array($result)) { //
                        ...
                        <tr>
                            ...
                            <td>
                                <?= htmlspecialchars($nama_barang_rusak_tipe ? $nama_barang_rusak_tipe . ' (' . $kondisi_barang_rusak . ')' : '-'); ?>
                            </td>
                    ...
                    <tr>
                        <td colspan="5" class="text-center">
                            <?php
                            if (!$result) {
                                echo "Gagal mengambil data pemeliharaan dari database: " . mysqli_error($conn) . ".";
                            } else {
                                echo "Tidak ada data pemeliharaan ditemukan.";
                            }
                            ?>
                        </td>
                    </tr>
