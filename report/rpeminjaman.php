...
$tgl = strftime("%e %B %Y"); // Tanggal saat ini di Banjarmasin
...
<div class="container-fluid">
    ...
    <div class="table-responsive">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                <?php
                // Query untuk mengambil semua data peminjaman dengan JOIN ke tabel barang dan pegawai
                $query = "
                    SELECT 
                        p.id_peminjaman,
                        p.jumlah_pinjam, 
                ...
                if ($result && mysqli_num_rows($result) > 0) { //
                    ...
                    while ($data = mysqli_fetch_array($result)) { //
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?= htmlspecialchars($jumlah_pinjam); ?></td> 
                    ...
                    <tr>
                        <td colspan="7" class="text-center">
                            <?php
                            if (!$result) {
                                echo "Gagal mengambil data peminjaman dari database: " . mysqli_error($conn) . ".";
                            } else {
                                echo "Tidak ada data peminjaman ditemukan.";
                            }
                            ?>
                        </td>
                    </tr>
