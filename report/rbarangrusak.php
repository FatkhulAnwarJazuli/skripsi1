...
$tgl = strftime("%e %B %Y", strtotime("2025-06-27")); // Menggunakan tanggal hari ini sesuai informasi terkini
...
<div class="container-fluid">
    ...
    <div class="table-responsive">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                <?php
                // Query untuk mengambil semua data barang rusak dengan JOIN ke tabel 'barang'
                $query = "SELECT br.id_rusak, b.namabarang, b.merk, br.jumlah, br.kondisi, br.status 
                          FROM barang_rusak br
                          JOIN barang b ON br.id_barang = b.id_barang
                          ORDER BY br.id_rusak DESC";
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    <tr>
                        <td colspan="6" class="text-center">
                            <?php
                            if (!$result) {
                                echo "Gagal mengambil data barang rusak dari database: " . mysqli_error($conn) . ".";
                            } else {
                                echo "Tidak ada data barang rusak ditemukan.";
                            }
                            ?>
                        </td>
                    </tr>
