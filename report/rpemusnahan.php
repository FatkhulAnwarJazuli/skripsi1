...
<div class="container-fluid">
    <table border="0" class="header-table">
        <tr>
            ...
            <td class="align-center">
                ...
                <hr class="line">
                <h3 style="text-align: center;">LAPORAN PEMUSNAHAN BARANG</h3>
            </td>
        </tr>
    </table>
    ...
    <div class="table-responsive">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                <?php
                // Query untuk mengambil semua data pemusnahan dengan JOIN
                $query = "
                    SELECT
                        p.id_pemusnahan,
                        p.jumlah,
                    ...
                    ORDER BY
                        p.id_pemusnahan ASC"; // Urutkan berdasarkan ID
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    <tr>
                        <td colspan="5" class="text-center">
                            <?php
                            if (!$result) {
                                echo "Gagal mengambil data pemusnahan dari database: " . mysqli_error($conn) . ".";
                            } else {
                                echo "Tidak ada data pemusnahan ditemukan.";
                            }
                            ?>
                        </td>
                    </tr>
