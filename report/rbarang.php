...
// Tanggal saat ini di Banjarmasin adalah 23 Juni 2025
$tgl = strftime("%e %B %Y"); 
    ...
    <div class="table-responsive">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                $query = "SELECT id_barang, namabarang, merk, jumlah FROM barang ORDER BY id_barang DESC";
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    <tr>
                        <td colspan="4" class="text-center">
                            <?php
                            if (!$result) {
                                echo "Gagal mengambil data barang dari database: " . mysqli_error($conn) . ".";
                            } else {
                                echo "Tidak ada data barang ditemukan.";
                            }
                            ?>
                        </td>
                    </tr>
...
<script>
    $(document).ready(function() {
        $('#example1').DataTable({
            ...
            // scrollY: "false", // Baris ini dan scrollCollapse tidak lagi diperlukan jika ingin menghilangkan scroll
